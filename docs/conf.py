...
#
html_theme_options = {
    'description': 'Lightweight Electrum AIPG Server in Python',
    'github_user': 'Electrum-AIPG',
...
latex_documents = [
    (master_doc, 'ElectrumX.tex', 'ElectrumX AIPG Documentation',
...
man_pages = [
    (master_doc, 'electrumx', 'ElectrumX AIPG Documentation',
     [author], 1)
]
