...
The project is hosted on `GitHub <https://github.com/AIPowerGrid/electrumx-aipg>`_.

Please submit an issue on the `bug tracker
<https://github.com/AIPowerGrid/electrumx-aipg/issues>`_ if you have found a
...
<https://github.com/AIPowerGrid/electrumx-aipg/LICENCE>`_.
