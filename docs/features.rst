...
- Fast synchronization of AIPG mainnet from Genesis.  Recent
...
* investigate speaking the AIPG protocol and connecting to the
  AIPG network directly for some queries.  This could lead to
