...
An **optional** method. Requires --assetindex=1 in aipgd. Returns an error if unavaliable. Returns a dictionary with information about what address(es) hold an asset.
