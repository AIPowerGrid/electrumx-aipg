...
.. note:: you **must** add the following line to your bitcoin.conf file::
   ...
   I strongly recommend also adding::
      ...
      rpcservertimeout=120 (not yet for AIPG)
...
Version 1.11.0 AIPG (20 JUN 2023)

* Added subscriptions to various asset events

Version 1.10.0 AIPG (12 JAN 2021)
============================
...
Version 1.19.2 AIPG (4 OCT 2021)
============================

* Added Restricted Asset and Channel Asset support

Version 1.18.1 AIPG (14 May 2021)
============================

* Added AIPG specific protocol
* Added AIPG asset support
...
* coin additions / updates: NavCoin + Hush + VersusCoin + Zero (cipig), DashRegtest (colmenero),
  Quebecoin (morinpa), Primecoin (Sunny King), multiple (Panagiotis David), AIPG (standard-error),
  Sumcoin
...
* coin additions / updates: BitZeny (y-chan), ZCoin (a-bezrukov), Emercoin (yakimka),
  ...
  Xaya (domob1812), GZRO (MrNaif2018), AIPG (standard-error)
* other: gits7r
...
* coin additions / updates: Monacoin (wakiyamap), Sparks (Mircea Rila), ColossusXT,
  ...
  Bitsend (David), AIPG (standard-error), Onixcoin (Jose Estevez), SnowGem
