...
You **must** to be running a non-pruning AIPG daemon with::
...
HDD.  Currently to around height 1,750,000 of the AIPG blockchain the
...
Check out the code from Github::
    ...
    git clone https://github.com/AIPowerGrid/electrumx-aipg.git
    cd electrumx
...
.. _`contrib/systemd/electrumx.service`: https://github.com/AIPowerGrid/electrumx-aipg/blob/master/contrib/systemd/electrumx.service
...
.. _`contrib/raspberrypi3/install_electrumx.sh`: https://github.com/AIPowerGrid/electrumx-aipg/blob/master/contrib/raspberrypi3/install_electrumx.sh
.. _`contrib/raspberrypi3/run_electrumx.sh`: https://github.com/AIPowerGrid/electrumx-aipg/blob/master/contrib/raspberrypi3/run_electrumx.sh
